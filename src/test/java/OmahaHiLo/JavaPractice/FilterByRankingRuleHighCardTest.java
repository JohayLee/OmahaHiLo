    ...
    extends TestCase
{
    ...
    public void testAFilterByHighRankingRuleHighCard()
    {
    	...
    	Map<RankingRule, List<Card[]>> rankedListHandA = CardsRankingUtils.FilterByRankingRule(handA, OmahaComp.OmahaHiRankingRules[8]);
    ...
    public void testBFilterByHighRankingRuleHighCard()
    {
    	...
    	// Filter by ranking rule
    	Map<RankingRule, List<Card[]>> rankedListHand = CardsRankingUtils.FilterByRankingRule(hand, OmahaComp.OmahaHiRankingRules[8]);
