    ...
    extends TestCase
{
    ...
    {
    	Card[] cards1 = PokerUtils.GetCardsFromNotationsString("Jc-Ah-Ac-Kc-As");
    	Card[] cards2 = PokerUtils.GetCardsFromNotationsString("Ks-3d-Kh-Kd-Ad");
    ...
    {
    	Card[] cards1 = PokerUtils.GetCardsFromNotationsString("3h-Kc-3c-3s-Jc");
    	Card[] cards2 = PokerUtils.GetCardsFromNotationsString("3s-3h-4d-3d-Ad");
    	ThreeOfAKind rule = new ThreeOfAKind();
    	assertTrue(rule.CompareCards(cards1, cards2) < 0 );
    }
    ...
    {
    	Card[] cards1 = PokerUtils.GetCardsFromNotationsString("3h-Kc-3c-3s-Jc");
    	Card[] cards2 = PokerUtils.GetCardsFromNotationsString("Jh-3d-Kc-3c-3s");
    	ThreeOfAKind rule = new ThreeOfAKind();
    	assertTrue(rule.CompareCards(cards1, cards2) == 0 );
    }
