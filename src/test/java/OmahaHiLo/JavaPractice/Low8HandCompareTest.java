    ...
    extends TestCase
{
    ...
    {
    	// Mock data
    	Card[] cards1 = PokerUtils.GetCardsFromNotationsString("Ah-7d-6c-2s-5c");
    	Card[] cards2 = PokerUtils.GetCardsFromNotationsString("3d-8s-4c-2s-5c");
    	Low8 low8 = new Low8();
    ...
    public void testLow8HandCompareSame()
    {
    	// Mock data
    	Card[] cards1 = PokerUtils.GetCardsFromNotationsString("Ah-7d-6c-2s-5c");
    	Card[] cards2 = PokerUtils.GetCardsFromNotationsString("2d-6s-7c-5s-Ac");
    	Low8 low8 = new Low8();
    	assertTrue(low8.CompareCards(cards1, cards2) == 0 );
    }
}
